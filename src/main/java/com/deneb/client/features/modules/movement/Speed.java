...
import com.deneb.client.utils.WorldTimer;
...
public class Speed extends Module {
    ...
    DValue speed = setting("Speed",1.0,0,50);
    BValue airMotion = setting("InAirMotion",true);
    BValue autoJump = setting("AutoJump",true);
    BValue useTimer = setting("UseTimer", true);
    BValue IceSpeed = setting("IceSpeed", false);
    FValue slipperiness = setting("Slipperiness",0.4F,0.2F,1.0F).b(IceSpeed);
