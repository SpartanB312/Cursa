...
import com.deneb.client.features.modules.misc.AutoTool;
...
public class Aura extends Module {
    ...
    DValue range = setting("Range", 5.5d,0.0d,10.0d);
    BValue wait = setting("Wait", true);
    BValue walls = setting("Walls", false);
    BValue sharpness = setting("32k Switch", false);
