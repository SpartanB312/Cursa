...
import com.deneb.client.utils.ColourUtils;
 ...
 */
@Module.Info(name = "StorageESP", description = "Draws nice little lines around storage items", category = Category.RENDER)
public class StorageESP extends Module {
    ...
    public void onWorldRender(RenderEvent event) {
        ...
        for (Triplet<BlockPos, Integer, Integer> pair : a)
            DenebTessellator.drawBox(pair.getFirst(), changeAlpha(pair.getSecond(), 100), pair.getThird());
