...
public class Colors extends Module {
    ...
    public FValue rainbowSpeed = setting("Rainbow Speed", 5.0f,0.0f,30.0f).visibility(v -> rainbow.getValue());
    public FValue rainbowSaturation = setting("Saturation",0.65f,0.0f,1.0f).visibility(v -> rainbow.getValue());
    public FValue rainbowBrightness = setting("Brightness",1.0f,0.0f,1.0f).visibility(v -> rainbow.getValue());
    ...
    public MValue setting =setting("Setting",new MValue.Mode("Rect",true),new MValue.Mode("Side"),new MValue.Mode("None"));
