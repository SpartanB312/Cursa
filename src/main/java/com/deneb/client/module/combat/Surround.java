...
import com.deneb.client.utils.BlockInteractionHelper;
...
public class Surround extends Module {
    ...
    BValue autoDisable = setting("Disable on place", true);
    BValue spoofRotations = setting("Spoof Rotations", true);
    BValue spoofHotBar = setting("Spoof HotBar", false);
    IValue blockPerTick = setting("Blocks per Tick",4,1,20);
    MValue autoCenter = setting("Auto Center",new MValue.Mode("TP",true),new MValue.Mode("OFF",false));
    BValue placeAnimation = setting("Place Animation", false);
