package com.deneb.client.module.misc;
...
public class StashFinder extends Module {
    ...
    BValue chest = setting("Chests", true);
    BValue shulker = setting("Shulker boxes", true);
    BValue donkey = setting("Donkey", true);
    BValue enderChest = setting("Ender Chest", true);
    BValue autowalk = setting("AutoWalk", false);
    BValue chat = setting("Send Message", false);
