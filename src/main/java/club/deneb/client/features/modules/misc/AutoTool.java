 ...
 */
@Module.Info(name = "AutoTool", description = "Automatically switch to the best tools when mining or attacking", category = Category.MISC)
public class AutoTool extends Module {

    @SubscribeEvent
    public void leftClickListener(PlayerInteractEvent.LeftClickBlock event) {
